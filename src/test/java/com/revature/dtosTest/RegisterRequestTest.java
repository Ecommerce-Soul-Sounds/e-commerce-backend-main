...
public class RegisterRequestTest {
    ...
    void testequals() {
        RegisterRequest rr1 = new RegisterRequest("jowill@gmail.com", "jwill", "Jo", "Will", "line1", "Apt1", "Chicago",
                "Illinois", 60616);
        RegisterRequest rr2 = new RegisterRequest("jowill@gmail.com", "jwill", "Jo", "Will", "line1", "Apt1", "Chicago",
                "Illinois", 60616);
    ...
    void testtoString() {
        RegisterRequest rr1 = new RegisterRequest("tech@gmail.com", "jwill", "Jo", "Will", "line1", "Apt1", "Chicago",
                "Illinois", 60616);
        assertEquals(
                "RegisterRequest(email=tech@gmail.com, password=jwill, firstName=Jo, lastName=Will, street_address=line1, apt=Apt1, city=Chicago, state=Illinois, zipcode=60616)",
                rr1.toString());
    }
