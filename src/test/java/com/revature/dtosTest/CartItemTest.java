...
public class CartItemTest {
    ...
    void testequals() {
		CartItemDTO ci1=new CartItemDTO(1,5);
	    CartItemDTO ci2=new CartItemDTO(1,5);
    ...
    void testtoString() {
	   CartItemDTO pi1=new CartItemDTO(1,5);
		
		assertEquals("CartItemDTO(productId=1, quantity=5)", pi1.toString());
		}
	@Test
    @Order(3)
