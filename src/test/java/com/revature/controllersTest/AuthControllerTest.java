...
class AuthControllerTest {
	...
	void testRegister() throws Exception {
		...
		RegisterRequest body = new RegisterRequest(email, password, firstName, lastName, line1, line2, city, state,
				zip);

		when(mockAuthService.register(new User(0, email, password, firstName, lastName),
				new Address(0, line1, line2, city, state, zip)))
				.thenReturn(user1);
